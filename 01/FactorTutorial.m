...
% FACTORS.INPUT(4) contains P(X_2)
%FACTORS.INPUT(4) = struct('var', [2], 'card', [2], 'val', [0.2607, 0.7393]);
...
% Factor Product
FACTORS.PRODUCT_TEST = FactorProduct(FACTORS.INPUT(1), FACTORS.INPUT(2));
...
FACTORS.MARGINALIZATION_TEST = FactorMarginalization(FACTORS.INPUT(2), [2]);
FACTORS.MARGINALIZATION = struct('var', [1], 'card', [2], 'val', [1 1]); 

% Observe Evidence
FACTORS.EVIDENCE_TEST = ObserveEvidence(FACTORS.INPUT, [2 1; 3 2]);
